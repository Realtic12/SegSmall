...
class iouEval:
    ...
    def __init__(self, nClasses, ignoreIndex=30):
    ...
    def addBatch(self, x, y):   #x=preds, y=targets
        ...
        #print(f"Shape Batch Outputs {x.shape}")  # Should be [batch_size, 1, H, W] or [batch_size, self.nClasses, H, W]
        #print(f"Shape Targets {y.shape}")        # Should be [batch_size, 1, H, W] or [batch_size, self.nClasses, H, W]
